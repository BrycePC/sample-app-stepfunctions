...
```bash
sample-app-stepfunctions$ sam build
```
...
```bash
sample-app-stepfunctions$ sam logs -n StockCheckerFunction --stack-name sample-app-stepfunctions --tail
```
...
```bash
sample-app-stepfunctions$ cd functions/<function-name>/
...
```bash
aws cloudformation delete-stack --stack-name sample-app-stepfunctions
```
